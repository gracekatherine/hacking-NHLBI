## Read in CARDIA files
## Note: throws a warning of "embedded nul(s) found in input" for i = 94 and i = 236...
## [94] "phs000285.v3.pht001647.v2.p2.c1.BFLWUPT1.HMB-IRB.txt"
## [236] "phs000285.v3.pht001789.v2.p2.c1.E1F40.HMB-IRB.txt"
## Also: "phs000285.v3.pht001703.v2.D1APOE.data_dict.csv"" has no children, so
## "phs000285.v3.pht001703.v2.D1APOE.data_dict_Children.csv" was deleted

setwd("~/Desktop/work/2015-2018/HMS DBMI/CARDIA")
library(XML)
