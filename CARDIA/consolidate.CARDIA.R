## Consolidate CARDIA files
setwd("~/Desktop/work/HMS DBMI/CARDIA")

## Establish two groups: data dictionary files and children files
## NB: list lengths are unequal because "phs000285.v3.pht001703.v2.D1APOE.data_dict.csv"
## has no children, so "phs000285.v3.pht001703.v2.D1APOE.data_dict_Children.csv" was deleted
...
for (i in 1:n) {
      ...
      file_path <- paste("./CSVFiles/", file_name_i, sep = "")
      children_i <- read.csv(file_path, row.names = NULL)
