...
setwd("~/Desktop/work/HMS DBMI/WHI")

## Establish two groups: data dictionary files and children files
## NB: list lengths are unequal because "phs000200.v9.pht001032.v6.WHI_Sample.data_dict.csv"
## has no children, so "phs000200.v9.pht001032.v6.WHI_Sample.data_dict_Children.csv" was deleted
