## Consolidate Framingham files
setwd("~/Desktop/work/HMS DBMI/Framingham")

## Establish two groups: data dictionary files and children files
## NB: list lengths are unequal because "phs000007.v22.pht001415.v10.Framingham_Sample.data_dict.csv"
## has no children, so "phs000007.v22.pht001415.v10.Framingham_Sample.data_dict_Children.csv" was deleted

## [1] 293
## Warning in `[<-.factor`(`*tmp*`, ri, value = c(1, 7, 0.000913192, 0.0087437,
## :invalid factor level, NA generated

## [1] 192
## Warning in `[<-.factor`(`*tmp*`, ri, value = c(0L, 1L, 3L, 1885L, 1890L,  :
## invalid factor level, NA generated
...
for (i in 1:n) {
      ...
      file_path <- paste("./CSVFiles/", file_name_i, sep = "")
      children_i <- read.csv(file_path, stringsAsFactors = FALSE)
