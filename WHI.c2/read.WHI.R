...
for (i in 2:num_files) {
      ...
      txt_path_old = paste("./PhenotypeFiles-v10/", txt_name_old, sep = "")
      txt_name_new = paste(txt_name, ".csv", sep = "")
      txt_path_new = paste("./CSVFiles-v10/", txt_name_new, sep = "")
      ...
      xml_name_old = paste("./PhenotypeFiles-v10/", xml_name, sep = "")
      xml_name_new = paste("./CSVFiles-v10/", xml_name_short, ".csv", sep = "")
      ...
      variables_start <- variables_end - num_variables + 2
...
## Convert variables and children to data frames, export to CSV(s)
      ...
      children_name = paste("./CSVFiles-v10/", xml_name_short, "_Children.csv", sep = "")
