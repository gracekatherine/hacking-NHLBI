## Read in Framingham files
setwd("~/Desktop/work/2015-2018/HMS DBMI/Framingham")
library(XML)
...
for (i in 1:num_files) {
      ...
      for (j in variables_start:variables_end) {
            ...
            ## NB: Because the "type" entry is vacant for all the
            ## Framingham data, it will be ignored from here on.
            ...
            ## Parse out attributes/comments for encoded values
