## Read in ARIC files
setwd("~/Desktop/Work/2015-2018/HMS DBMI/ARIC")
library(XML)

## Create list of all text and XML data files in ARIC cohort
...
for (i in 1:num_files) {
      ...
      for (j in variables_start:variables_end) {
            ...
            xml_df = cbind(name, description[2:length(description)], type)
